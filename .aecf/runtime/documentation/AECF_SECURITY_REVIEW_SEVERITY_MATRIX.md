...
`.aecf/runtime/documentation/AECF_SECURITY_REVIEW_SEVERITY_MATRIX.md`
...
| SEC-CSRF-01 | CSRF | POST endpoint without CSRF token validation on state-changing operation | HIGH |
...
| SEC-ENUM-01 | Input Validation | Search query with empty/null parameter returns all records without access control | MEDIUM |
| SEC-FILE-01 | File Handling | Unrestricted file upload without validation | HIGH |
| SEC-INFO-01 | Configuration | Demo or debug route accessible in production deployment | MEDIUM |
...
- v1: Initial project baseline from template. (2026-04-18)
- v1.1: Added SEC-CSRF-01 (CSRF protection absent on POST endpoints) from controller_security review. Source: .aecf/runtime/documentation/lvillara/controller_security/AECF_01_SECURITY_AUDIT.md (2026-04-18).
- v1.2: Added SEC-INFO-01 (Demo/debug route accessible in production) from controller_security review. Source: .aecf/runtime/documentation/lvillara/controller_security/AECF_01_SECURITY_AUDIT.md (2026-04-18).
- v1.3: Added SEC-ENUM-01 (Data enumeration via unrestricted search query) from controller_security review. Source: .aecf/runtime/documentation/lvillara/controller_security/AECF_01_SECURITY_AUDIT.md (2026-04-18).
